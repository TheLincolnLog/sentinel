...
MODEL_OUT = Path(__file__).with_name("model.pkl")
...
print(f"✓  Saved {MODEL_OUT}  (val_acc={best_val_acc:.4f}, epochs={EPOCHS})")
...
print(f"\nDone. Model is ready at {MODEL_OUT}.\n")
